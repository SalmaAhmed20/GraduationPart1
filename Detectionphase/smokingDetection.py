...
def run(v_path):
    ...
    writer = cv2.VideoWriter('SmokingDemo.mp4', cv2.VideoWriter_fourcc(*'DIVX'), 20, (width, height))
    with mp_pose.Pose(
        ...
        while video.isOpened():
            ...
            ori_image = cv2.resize(image, (width, height))
...
if __name__ == '__main__':
    run("D:\\Graduation project\\Graduation Part1\\WhatsApp Video 2022-07-13 at 7.57.06 PM.mp4")